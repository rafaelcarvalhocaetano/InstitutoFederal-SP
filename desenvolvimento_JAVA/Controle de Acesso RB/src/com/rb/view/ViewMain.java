...
public class ViewMain extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setBackground(new java.awt.Color(41, 128, 185));
        jComboBox1.setEditable(true);
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "RB", "TER" }));
        ...
        jComboBox4.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "C", "V" }));

        jLabel7.setText("Lacre");
